...
const About: React.FC = () => {
  return (
    <div className="bg-transparent text-on-surface font-body selection:bg-primary-fixed selection:text-on-primary-fixed min-h-screen relative">
      ...
      <header className="fixed top-0 w-full z-50 bg-white/70 dark:bg-slate-900/80 backdrop-blur-2xl border-b border-emerald-500/10 transition-all">
        <nav className="flex justify-between items-center px-8 py-6 max-w-full mx-auto">
          <div className="flex items-center gap-4 cursor-pointer" onClick={() => navigate('/dashboard')}>
            ...
            <div className="flex flex-col">
              <span className="text-xl font-black font-headline text-emerald-950 dark:text-emerald-50 tracking-tighter leading-none uppercase">
                Architecture <span className="text-emerald-500 italic">Labs</span>
              </span>
          ...
          <div className="hidden lg:flex items-center gap-8 text-[10px] uppercase font-black tracking-widest text-slate-400">
            <a className="hover:text-emerald-500 transition-colors" href="#">The Brain</a>
            <div className="w-1 h-1 rounded-full bg-emerald-500/20"></div>
            <a className="hover:text-emerald-500 transition-colors" href="#">The Muscle</a>
            <div className="w-1 h-1 rounded-full bg-emerald-500/20"></div>
            <a className="text-emerald-500" href="#">The Engine</a>
          </div>
          <div className="flex items-center gap-4">
            ...
            <button className="w-10 h-10 rounded-2xl bg-slate-100 dark:bg-slate-800 flex items-center justify-center text-slate-500 hover:bg-emerald-500 hover:text-white transition-all">
